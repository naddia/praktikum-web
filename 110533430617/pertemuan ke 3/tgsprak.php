...
<title> Tugas Praktikum Nadia </title>
<script type="text/javascript">
function validation() {  //untuk fungsi validasi
  var username = formlogin.username.value; //var username mengakses value dari username formlogin 
  var passwd = formlogin.password.value;  //var password mengakses value password formlogin
